    ...
    <main className="container mx-auto px-4 py-8">
      <div className="text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-8">
          ...
          <div className="p-6 bg-white rounded-lg shadow-md">
            <h2 className="text-2xl font-bold mb-2">Spaces OS</h2>
            <p className="text-gray-600">Collaborative workspace environment</p>
            <a href="/spaces" className="text-blue-500 hover:text-blue-700 mt-2 inline-block">
              Launch Spaces
            </a>
          </div>
        </div>
